...
* Use [github issues](https://github.com/EurekaCommunity/PostalAddressRow/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/EurekaCommunity/PostalAddressRow/releases).
  * Check if the issue was [already reported or fixed](https://github.com/EurekaCommunity/PostalAddressRow/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
1. Fork the PostalAddressRow repository.
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/PostalAddressRow.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:EurekaCommunity/PostalAddressRow.git`
